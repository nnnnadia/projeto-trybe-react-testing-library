const pokemons = [
  ...
  },
  {
    ...
    summary: 'It can freely detach its jaw to swallow large prey'
    + ' whole. It can become too heavy to move, however.',
  },
  {
    id: 65,
    name: 'Alakazam',
    ...
    summary: 'Closing both its eyes heightens all its other'
    + ' senses. This enables it to use its abilities to their extremes.',
  },
  {
    id: 151,
    name: 'Mew',
  ...
  },
  {
    ...
    summary: 'At full gallop, its four hooves barely touch the'
    + ' ground because it moves so incredibly fast.',
  },
  {
    id: 143,
    name: 'Snorlax',
...
const getRandomBetween = (min = 0, max = pokemonsLength - 1) => {
  min = Math.ceil(min);
  max = Math.floor(max);
